...
class Bagian extends Admin_Controller
{
    public function __construct ()
    {
        parent::__construct();
        $this->load->model('master/bagian_m');
    }

    public function index ()
    {
        
        if(isset($_GET['bagian']) == TRUE){
            echo $this->bagian_m->getJson();
        }
        else{
            $this->data['subview'] = 'app/master/bagian'; // Load view
